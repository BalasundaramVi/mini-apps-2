      ...
      return (
        <div className={`score_box box_${i}`} key={`frame_${i + 1}`}>
          <div className="top_row">
            ...
            {box.thirdBowl !== undefined ? (box.thirdBowl >= 0 || (box.thirdBowl === 'X' || box.thirdBowl === '/') ? <div className="bowl_2">{box.thirdBowl}</div> : <div className="bowl_2 invisible">{box.thirdBowl}</div>) : ''}
          </div>
